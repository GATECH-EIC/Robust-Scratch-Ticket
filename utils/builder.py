...
class Builder(object):
    ...
    def conv(self, kernel_size, in_planes, out_planes, stride=1, first_layer=False, **kwargs):
        ...
        if kernel_size == 3:
            ...
            conv = conv_layer(
                in_planes, out_planes, kernel_size=1, stride=stride, bias=False, **kwargs
            )
        elif kernel_size == 5:
            conv = conv_layer(
                in_planes,
    ...
    def conv3x3(self, in_planes, out_planes, stride=1, first_layer=False, **kwargs):
        """3x3 convolution with padding"""
        c = self.conv(3, in_planes, out_planes, stride=stride, first_layer=first_layer, **kwargs)
        return c

    def conv1x1(self, in_planes, out_planes, stride=1, first_layer=False, **kwargs):
        """1x1 convolution with padding"""
        c = self.conv(1, in_planes, out_planes, stride=stride, first_layer=first_layer, **kwargs)
        return c

    def conv7x7(self, in_planes, out_planes, stride=1, first_layer=False, **kwargs):
        """7x7 convolution with padding"""
        c = self.conv(7, in_planes, out_planes, stride=stride, first_layer=first_layer, **kwargs)
        return c

    def conv5x5(self, in_planes, out_planes, stride=1, first_layer=False, **kwargs):
        """5x5 convolution with padding"""
        c = self.conv(5, in_planes, out_planes, stride=stride, first_layer=first_layer, **kwargs)
        return c
